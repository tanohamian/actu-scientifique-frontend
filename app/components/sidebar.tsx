...
export default function SidebarComponent({ onClose, isMobile }: { onClose?: () => void; isMobile: boolean }){
    ...
    const navItems : NavItems[] = [
        ...
        {name:"Medias", path:"/admin/dashboard/medias", icon: <IconComponent name='Video' {...iconBaseProps} />},
        {name:"Formations & Bourses", path:"/admin/dashboard/formations_bourses", icon: <IconComponent name='Feed' {...iconBaseProps} />},
        {name:"Newsletters", path:"/admin/dashboard/newsletters", icon: <IconComponent name='Envelope' {...iconBaseProps} />},
        {name:"Produit & Commandes", path:"/admin/dashboard/produit_commandes", icon: <IconComponent name='Product' {...iconBaseProps} />},
        ...
        {name:"Evènements", path:"/admin/dashboard/event", icon: <IconComponent name='Schedule' {...iconBaseProps} />}
    ];
