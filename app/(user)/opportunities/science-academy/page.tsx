        ...
        <div className="min-h-screen  text-slate-50 relative overflow-hidden">
            ...
            <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-32">
                ...
                <div className="mb-16 relative">
                    <div className="absolute -left-6 top-0 bottom-0 w-1 bg-gradient-to-b from-transparent via-cyan-400 to-transparent"></div>
                    ...
                    <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold mb-6 leading-none">
                        <span className="block bg-gradient-to-r from-slate-50 via-cyan-200 to-slate-50 bg-clip-text text-transparent animate-[shimmer_3s_ease-in-out_infinite]" style={{
