...
export default function LoginRegisterComponent({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      if (type === "login") {
        const email =
          inputs.find((i) => i.typeInput === "email")?.inputValue || "";
        const password =
          inputs.find((i) => i.typeInput === "password")?.inputValue || "";
        ...
        const firstName =
          inputs.find((i) => i.placeholderInput === "Nom")?.inputValue || "";
        const lastName =
          inputs.find((i) => i.placeholderInput === "Prenom")?.inputValue || "";
        const email =
          inputs.find((i) => i.typeInput === "email")?.inputValue || "";
        const password =
          inputs.find((i) => i.typeInput === "password")?.inputValue || "";
        const confirmPassword =
          inputs.find((i) => i.placeholderInput === "Confirmer le mot de passe")
            ?.inputValue || "";
